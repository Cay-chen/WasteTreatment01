...
// 创建历史轨迹请求实例
        HistoryTrackRequest historyTrackRequest = new HistoryTrackRequest(tag, serviceId, entityName);
         ...
         long startTime =dateTimeStamp("2020-04-02 17:58:35","yyyy-MM-dd HH:mm:ss");
        long endTime =dateTimeStamp("2020-04-02 18:04:57","yyyy-MM-dd HH:mm:ss");
...
// 初始化轨迹监听器
        OnTrackListener mTrackListener = new OnTrackListener() {
            ...
            public void onHistoryTrackCallback(HistoryTrackResponse response) {
                ...
                Log.d(WasteTreatmentApplication.TAG, "points: "+points.toString());
