...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  ...
  @NonNull
  public final LinearLayout llYfck;

  @NonNull
  public final LinearLayout llYfcx;

  @NonNull
  public final LinearLayout llYfrk;

  @NonNull
  public final LinearLayout llYfsj;

  @NonNull
  public final LinearLayout llYfxf;

  @NonNull
  public final LinearLayout llYfys;

  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      BaseTitleBinding ilTitle, LinearLayout llBaiduMap, LinearLayout llBtn, LinearLayout llYfck,
      LinearLayout llYfcx, LinearLayout llYfrk, LinearLayout llYfsj, LinearLayout llYfxf,
      LinearLayout llYfys) {
    super(_bindingComponent, _root, _localFieldCount);
    this.ilTitle = ilTitle;
    setContainedBinding(this.ilTitle);
    this.llBaiduMap = llBaiduMap;
    this.llBtn = llBtn;
    this.llYfck = llYfck;
    this.llYfcx = llYfcx;
    this.llYfrk = llYfrk;
