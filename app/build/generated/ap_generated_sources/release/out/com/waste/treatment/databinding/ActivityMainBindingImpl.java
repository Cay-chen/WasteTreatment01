...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.scan_btn, 3);
        sViewsWithIds.put(R.id.gps_btn, 4);
        sViewsWithIds.put(R.id.qr_code_btn, 5);
        sViewsWithIds.put(R.id.img_btn, 6);
        sViewsWithIds.put(R.id.img_btn_luru, 7);
    }
    // views
    @NonNull
