...
public class FragmentHomeBindingImpl extends FragmentHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_baidu_map, 2);
        sViewsWithIds.put(R.id.ll_btn, 3);
        sViewsWithIds.put(R.id.ll_yfsj, 4);
        sViewsWithIds.put(R.id.ll_yfys, 5);
        sViewsWithIds.put(R.id.ll_yfrk, 6);
        sViewsWithIds.put(R.id.ll_yfck, 7);
        sViewsWithIds.put(R.id.ll_yfxf, 8);
        sViewsWithIds.put(R.id.ll_yfcx, 9);
    }
    // views
    @NonNull
