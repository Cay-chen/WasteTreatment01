...
public class FragmentSetBindingImpl extends FragmentSetBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_xingming, 2);
        sViewsWithIds.put(R.id.tv_id_name, 3);
        sViewsWithIds.put(R.id.ll_change_pwd, 4);
        sViewsWithIds.put(R.id.ll_print_set, 5);
        sViewsWithIds.put(R.id.ll_sclx, 6);
        sViewsWithIds.put(R.id.ll_lixiankefu, 7);
        sViewsWithIds.put(R.id.logout_btn, 8);
    }
    // views
    @NonNull
    ...
    public FragmentSetBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private FragmentSetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
