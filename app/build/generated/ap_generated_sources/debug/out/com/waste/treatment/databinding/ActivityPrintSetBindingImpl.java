...
public class ActivityPrintSetBindingImpl extends ActivityPrintSetBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.print_w_edt, 2);
        sViewsWithIds.put(R.id.print_h_edt, 3);
        sViewsWithIds.put(R.id.spinner_gray, 4);
        sViewsWithIds.put(R.id.print_revise_btn, 5);
    }
    // views
    @NonNull
    ...
    public ActivityPrintSetBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityPrintSetBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
